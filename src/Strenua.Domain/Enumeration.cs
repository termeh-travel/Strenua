...
namespace Strenua.Domain
{
    ...
    public abstract class Enumeration<TEnumeration, TIdentifier> : IComparable<TEnumeration>, IEquatable<TEnumeration> where TEnumeration : Enumeration<TEnumeration, TIdentifier> where TIdentifier : IComparable
    {
        public static readonly IReadOnlyCollection<TEnumeration> Values;
    ...
    public abstract class Enumeration<TEnumeration> : Enumeration<TEnumeration, int> where TEnumeration : Enumeration<TEnumeration, int>
    {
